  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-bg px-6">
      ...
      <div className="relative z-10 mb-4">
        <Mascot size="lg" message={mode === "signUp" ? t("mascotSignup") : t("tagline")} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-sm rounded-lg border border-border bg-surface p-6 animate-fade-up">
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={submit}
            disabled={loading}
            className="w-full rounded-sm bg-gold/15 py-2.5 text-sm font-medium text-gold transition hover:bg-gold/25 disabled:opacity-50"
          >
